 ...
 * Login Page
 *
 * Beautiful authentication page with glassmorphism effects and modern design.
 * Integrates with Better Auth for secure JWT-based authentication.
 */
...
export default function LoginPage({ translations: t }: LoginPageContentProps) {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (result.error) {
        setError(t('signInError') || "Login failed. Please check your credentials.");
        return;
      }
